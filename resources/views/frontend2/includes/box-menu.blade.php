        ...
        <div class="row left-box">
          ...
          <div class="col-md-6">
            ...
            color-classes: "nav-pills-primary", "nav-pills-info", "nav-pills-success", "nav-pills-warning","nav-pills-danger"
                              -->
              <li class="nav-item">
                <a class="nav-link active show" href="{{route('frontend.index','car')}}" role="tab"  aria-selected="true">
                  <i class="fa fa-car" aria-hidden="true"></i> Buy Car
                </a>
              </li>
              <li class="nav-item material-icons">
                <a class="nav-link active " href="{{route('frontend.index','car')}}" role="tab"  aria-selected="false">
